    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex flex-col items-center justify-center p-4 relative">
      <div className="text-center space-y-12 max-w-2xl mx-auto">
        ...
        <div className="relative">
          <Image
            src="/images/kova-logo-cropped.png"
            alt="KOVA Logo"
            width={400}
            height={400}
            ...
            priority
          />
          <p className="text-gray-300 text-lg md:text-xl font-light tracking-wide mt-4">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2">
        <div className="flex items-center space-x-6 text-gray-500 text-sm">
          <a href="mailto:hello@kova.fit" className="flex items-center space-x-1 hover:text-gray-300 transition-colors">
            <Mail size={16} />
            <p>hello@kova.fit</p>
          </a>
          <a
